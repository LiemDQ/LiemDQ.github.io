...
So how much energy is *actually* needed to separate a mixture's components from one another? What is, so to speak, the theoretical minimum? We're going to actually mathematically derive it in this section, but if you are not interested in that, 
